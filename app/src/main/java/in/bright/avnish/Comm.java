...
import static in.bright.avnish.URLs.CHAP_DISP;
...
public class Comm extends AppCompatActivity {
    ...
    private void loadProducts() {
         ...
         * */
        StringRequest stringRequest = new StringRequest(Request.Method.POST, CHAP_DISP,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                JSONObject chap = array.getJSONObject(i);

                                //adding the product to product list
                                chapList.add(new Chap(
                                        chap.getInt("id"),
                                        chap.getString("title"),
                                        chap.getString("dsc"),
                                        chap.getString("url")
                                ));
                            }
                            ...
                            ChapAdapter adapter = new ChapAdapter(Comm.this, chapList);
